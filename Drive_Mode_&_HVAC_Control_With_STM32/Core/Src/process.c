...
//	    if (
//	        id == Matel_MCU_POWER_CAN_STD_ID_A1  ||
//	        id == Matel_MCU_FAULT_one_CAN_STD_ID_AE ||
//	        id == Matel_MCU_FAULT_two_CAN_STD_ID_AF ||
//	        id == Matel_MCU_Fault_Code_CAN_STD_ID_B3  ||
//	        ( (
//	            id == Matel_MCU_Stat_One_CAN_EXTD_ID_18265040 ||
//	            id == Matel_MCU_Stat_Two_CAN_EXTD_ID_18275040
//	        ))
//	    )
//	    {
//	        mcu_timer = 0;
...
//	    // ----- Check BMS IDs -----
//	    else if (
//	        id == JBD_BMS_ID0  || id == JBD_BMS_ID1  || id == JBD_BMS_ID2  ||
//	        id == JBD_BMS_ID4  || id == JBD_BMS_ID5  || id == JBD_BMS_ID6  ||
//	        id == JBD_BMS_ID7  || id == JBD_BMS_ID8  || id == JBD_BMS_ID9  ||
//	        id == JBD_BMS_ID10 || id == JBD_BMS_ID11 || id == JBD_BMS_ID12)
//	    {
//	        bms_timer = 0;
//	        bms_connected = 1;
//	    }
